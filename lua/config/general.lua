...
vim.opt.showcmdloc = "statusline" -- show partial commands in the statusline
...
vim.opt.shortmess:append("ci") -- reduce ui message clutter ("c": avoid extra completion messages - "i": disable the intro message on startup)
...
vim.opt.redrawtime = 1500 -- max time (ms) for syntax highlighting redraw
vim.opt.synmaxcol = 120 -- stop syntax highlighting after 120 columns
vim.opt.updatetime = 250 -- how long to wait (ms) before cursorhold events fire (affects lsp & git signs)
