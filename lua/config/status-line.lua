...
local function set_mode()
    ...
    current_mode = "%#StatusLineMode#"
        .. "["
        .. (modes[mode] or mode:lower())
        .. "]"
end
...
local function set_git_branch()
    ...
    if branch ~= "" then
        current_git_branch = "%#StatusLineGitBranch#" .. branch
    else
        current_git_branch = ""
    end
end
...
local function set_filepath()
    ...
    if path ~= "" then
        current_file_path = "%#StatusLinePath#" .. path
    else
        current_file_path = ""
    end
end
...
local function set_lsp_status()
    ...
    if status == "" then
        ...
        current_lsp_status = "%#StatusLineLspStatus#" .. status
